...
import { Fullscreen, Mic } from "lucide-react";
...
const RecordAnswerSection = ({
  ...
  <div className="flex flex-col justify-center items-center rounded-lg p-5 bg-white mt-4 ml-40 w-[23rem] h-[20rem] relative">
    {webCamEnabled ? (
      <Webcam
        mirrored={true}
        className="absolute top-0 left-0 w-[23rem] h-[20rem] rounded-lg object-cover"
      />
    ) : (
      <Image
        src={"/camera.jpg"}
      ...
      <div className="md:flex mt-4 md:mt-8 md:gap-5 ">
        <div className="my-4 md:my-0 ml-40">
